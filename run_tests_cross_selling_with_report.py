...
def parse_test_results(output_lines, module_name):
    ...
    # Regex patterns - adaptados para el módulo de cross-selling
...
def generate_pdf_report(filename, stats, module_name):
    ...
    elements.append(Paragraph("Ventas - Reglas de Cross-Selling", styles['Heading2']))
...
if __name__ == "__main__":
    MODULE = "sale_cross_selling"
    DB = "test_cross_selling_clean"
    PORT = 8098
