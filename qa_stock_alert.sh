...
# Este script automatiza la ejecución de tests QA para el módulo Stock Critical Alert
# y la obtención del reporte PDF

CONTAINER_NAME="proj"
REMOTE_SCRIPT="/home/odoo/run_tests_stock_alert_with_report.py"
LOCAL_SCRIPT="./run_tests_stock_alert_with_report.py"
FINAL_REPORT_NAME="reporte_qa_stock_alert_mas_reciente.pdf"

echo "=== Iniciando Proceso de QA - Alertas de Stock Crítico ==="
...
LATEST_PDF=$(docker exec -u root $CONTAINER_NAME sh -c "ls -t /home/odoo/qa_report_stock_critical_alert_*.pdf | head -n 1")
