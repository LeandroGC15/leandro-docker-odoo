...
def parse_test_results(output_lines, module_name):
    ...
    # Regex patterns - adaptados para el módulo de fidelización POS
...
def generate_pdf_report(filename, stats, module_name):
    ...
    elements.append(Paragraph("Punto de Venta - Programa de Fidelización", styles['Heading2']))
...
if __name__ == "__main__":
    MODULE = "pos_loyalty_program"
    DB = "test_pos_loyalty_clean"
    PORT = 8099
