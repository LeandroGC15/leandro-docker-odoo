...
# Este script automatiza la ejecución de tests QA para el módulo RRHH - Evaluaciones de Desempeño
# y la obtención del reporte PDF

CONTAINER_NAME="proj"
REMOTE_SCRIPT="/home/odoo/run_tests_rrhh_with_report.py"
LOCAL_SCRIPT="./run_tests_rrhh_with_report.py"
FINAL_REPORT_NAME="reporte_qa_rrhh_mas_reciente.pdf"
MODULE_NAME="hr_performance_review"

echo "=== Iniciando Proceso de QA para RRHH - Evaluaciones de Desempeño ==="
