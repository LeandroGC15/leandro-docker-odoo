...
# Este script automatiza la ejecución de tests QA y la obtención del reporte PDF

CONTAINER_NAME="proj"
REMOTE_SCRIPT="/home/odoo/run_tests_with_report.py"
LOCAL_SCRIPT="./run_tests_with_report.py"
FINAL_REPORT_NAME="reporte_qa_mas_reciente.pdf"

echo "=== Iniciando Proceso de QA ==="
...
LATEST_PDF=$(docker exec -u root $CONTAINER_NAME sh -c "ls -t /home/odoo/qa_report_modulos_contabilidad_*.pdf | head -n 1")
