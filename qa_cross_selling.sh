...
# Este script automatiza la ejecución de tests QA para el módulo Ventas - Reglas de Cross-Selling
# y la obtención del reporte PDF

CONTAINER_NAME="proj"
REMOTE_SCRIPT="/home/odoo/run_tests_cross_selling_with_report.py"
LOCAL_SCRIPT="./run_tests_cross_selling_with_report.py"
FINAL_REPORT_NAME="reporte_qa_cross_selling_mas_reciente.pdf"
MODULE_NAME="sale_cross_selling"

echo "=== Iniciando Proceso de QA para Ventas - Reglas de Cross-Selling ==="
